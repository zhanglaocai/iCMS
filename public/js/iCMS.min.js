...
define("ui.dialog",function(o){var e=o("artdialog");return function(o,i){function n(o){window.clearTimeout(c),"function"==typeof i&&i(o)}function t(o){return'<table class="ui-dialog-table" align="center"><tr><td valign="middle"><div class="iPHP-msg"><span class="label label-'+a.label+'"><i class="fa fa-'+a.icon+'"></i> '+o+"</span></div></td></tr></table>"}var l={id:"iCMS-DIALOG",title:"iCMS - 提示信息",className:"iCMS_UI_DIALOG",backdropBackground:"#333",backdropOpacity:.5,fixed:!0,autofocus:!1,quickClose:!0,lock:!0,time:null,label:"success",icon:"check",api:!1},c=null,a=$.extend(l,iCMS.CONFIG.DIALOG,o);a.follow&&(a.fixed=!1,a.lock=!1,a.skin="iCMS_tooltip_popup",a.className="ui-popup",a.backdropOpacity=0);var s=a.content;s instanceof jQuery?a.content=s:"string"==typeof s&&(a.content=t(s)),a.onclose=function(){n("close")},a.onbeforeremove=function(){n("beforeremove")},a.onremove=function(){n("remove")};var r=e(a);return a.lock?r.showModal():(r.show(a.follow),a.follow),a.time&&(c=window.setTimeout(function(){r.destroy()},a.time)),r.destroy=function(){r.close().remove()},r}});
define("ui",{dialog:function(i){var e=require("ui.dialog");return e(i)},alert:function(i,e,c){var r=require("ui.dialog"),n=e?{label:"success",icon:"check"}:{label:"warning",icon:"warning"};n.id="iCMS-DIALOG-ALERT",n.skin="iCMS_dialog_alert",n.content=i,n.time=3e3,n.lock=!0,r(n,c)},seccode:function(i,e){var c=require("api"),i=i||".seccode-img",e=e||"body";$(i,e).attr("src",c.url("public","&do=seccode&")+Math.random())}});
define("utils",{addcss:function(e,r){e=iCMS.CONFIG.PUBLIC+"/"+e;var a=document.createElement("link"),l=document.getElementsByTagName("head")[0];a.id=r,a.href=e,a.type="text/css",a.rel="stylesheet",l.insertBefore(a,l.firstChild)},addjs:function(e,r){url=iCMS.CONFIG.PUBLIC+"/"+e+".js";var a=document.createElement("script"),l=document.getElementsByTagName("head")[0];a.id=r,a.src=url,l.insertBefore(a,l.firstChild)},format:function(e,r){function a(e,r){for(var a="",l=e.split("[iCMS.N]"),c=0;c<l.length;c++){for(;" "==l[c].substr(0,1)||"　"==l[c].substr(0,1);)l[c]=l[c].substr(1,l[c].length);l[c].length>0&&(a+=r?l[c]+"\n":"<p>"+l[c]+"</p>")}return a}return e=e.replace(/\/"/g,'"').replace(/\\\&quot;/g,"").replace(/\r/g,"").replace(/on(\w+)="[^"]+"/gi,"").replace(/<script[^>]*?>(.*?)<\/script>/gi,"").replace(/<style[^>]*?>(.*?)<\/style>/gi,"").replace(/style=[" ]?([^"]+)[" ]/gi,"").replace(/<a[^>]+href=[" ]?([^"]+)[" ]?[^>]*>(.*?)<\/a>/gi,"[url=$1]$2[/url]").replace(/<img[^>]+src=[" ]?([^"]+)[" ]?[^>]*>/gi,"[img]$1[/img]").replace(/<embed/g,"\n<embed").replace(/<embed[^>]+class="edui-faked-video"[^"].+src=[" ]?([^"]+)[" ]+width=[" ]?([^"]\d+)[" ]+height=[" ]?([^"]\d+)[" ]?[^>]*>/gi,"[video=$2,$3]$1[/video]").replace(/<embed[^>]+class="edui-faked-music"[^"].+src=[" ]?([^"]+)[" ]+width=[" ]?([^"]\d+)[" ]+height=[" ]?([^"]\d+)[" ]?[^>]*>/gi,"[music=$2,$3]$1[/music]").replace(/<b[^>]*>(.*?)<\/b>/gi,"[b]$1[/b]").replace(/<strong[^>]*>(.*?)<\/strong>/gi,"[b]$1[/b]").replace(/<p[^>]*?>/g,"\n\n").replace(/<br[^>]*?>/g,"\n").replace(/<li[^>]*?>/g,"\n").replace(/<[^>]*?>/g,""),r?(e=e.replace(/\n+/g,"[iCMS.N]"),e=a(e,r)):(e=e.replace(/\[url=([^\]]+)\]\n(\[img\]\1\[\/img\])\n\[\/url\]/g,"$2").replace(/\[img\](.*?)\[\/img\]/gi,'<p><img src="$1" /></p>').replace(/\[b\](.*?)\[\/b\]/gi,"<b>$1</b>").replace(/\[url=([^\]|#]+)\](.*?)\[\/url\]/g,"$2").replace(/\[url=([^\]]+)\](.*?)\[\/url\]/g,'<a target="_blank" href="$1">$2</a>').replace(/\n+/g,"[iCMS.N]"),e=a(e),e=e.replace(/#--iCMS.PageBreak--#/g,"<!---->#--iCMS.PageBreak--#").replace(/<p>\s*<p>/g,"<p>").replace(/<\/p>\s*<\/p>/g,"</p>").replace(/<p>\s*<\/p>/g,"").replace(/\[video=(\d+),(\d+)\](.*?)\[\/video\]/gi,'<embed type="application/x-shockwave-flash" class="edui-faked-video" pluginspage="http://www.macromedia.com/go/getflashplayer" src="$3" width="$1" height="$2" wmode="transparent" play="true" loop="false" menu="false" allowscriptaccess="never" allowfullscreen="true"/>').replace(/\[music=(\d+),(\d+)\](.*?)\[\/music\]/gi,'<embed type="application/x-shockwave-flash" class="edui-faked-music" pluginspage="http://www.macromedia.com/go/getflashplayer" src="$3" width="$1" height="$2" wmode="transparent" play="true" loop="false" menu="false" allowscriptaccess="never" allowfullscreen="true" align="none"/>').replace(/<p><br\/><\/p>/g,""))},random:function(e){e=e||16;var r="abcdefhjmnpqrstuvwxyz23456789ABCDEFGHJKLMNPQRSTUVWYXZ",a="";for(i=0;i<e;i++)a+=r.charAt(Math.floor(Math.random()*r.length));return a},callback:function(e,r,a,l,c){var i=r||l.SUCCESS,t=a||l.FAIL;e.code?this.__callback(i,e,c):this.__callback(t,e,c)},__callback:function(e,r,a){if("function"==typeof e)e(r,a);else{var l=r;"object"==typeof r&&(l=r.msg||"error");var c=require("ui");c.alert(l)}}});
define("user",function(e){var t=e("utils"),n=e("api"),a=e("ui");return $User={INBOX_URL:iCMS.CONFIG.API+"?app=user&do=manage&pg=inbox",widget:{loading:'<div class="tip_info"><img src="'+iCMS.CONFIG.PUBLIC+'/ui/loading.gif"><span> 用户信息加载中……</span></div>'}},$.extend($User,{NOAVATAR:function(e){e.src=iCMS.CONFIG.PUBLIC+"/ui/avatar.gif"},NOCOVER:function(e,t){var n="coverpic";"m"==t&&(n="coverpic"),e.src=iCMS.CONFIG.PUBLIC+"/ui/"+n+".jpg"},STATUS:function(e,a,i){var o=this;$.get(n.url("user","&do=data"),e,function(e){e.code&&($User.data=e),t.callback(e,a,i,o)},"json")},AUTH:function(){var t=e("cookie");return!!t.get(iCMS.CONFIG.AUTH)},CHECK:{LOGIN:function(){var e=$User.AUTH();return!!e||$User.LOGIN()}},UHOME:function(e){return iCMS.CONFIG.UHOME.replace("{uid}",e)},LOGIN:function(){window.location.href=n.url("user","&do=login")},LOGOUT:function(e,a,i){var o=this;$.get(n.url("user","&do=logout"),e,function(e){t.callback(e,a,i,o)},"json")},FOLLOW:function(e,a,i){var o=this;if(this.CHECK.LOGIN()){var r=$(e).attr("i").replace("follow:","").split(":"),c={uid:r[0],follow:r[1],action:"follow"};$.post(n.url("user"),c,function(e){t.callback(e,a,i,o,c)},"json")}},UCARD:function(){$("[i^='ucard']").poshytip({idName:"iCMS-UCARD",className:"iCMS_UI_TOOLTIP",alignTo:"target",alignX:"center",liveEvents:!0,offsetX:0,offsetY:5,fade:!1,slide:!1,content:function(e){var t=$(this).attr("i").replace("ucard:","");return t&&$.get(n.url("user","&do=ucard"),{uid:t},e),$User.widget.loading}})},PM:function(e){if(this.CHECK.LOGIN()){var t=($(e),document.getElementById("iCMS-PM-DIALOG")),i=a.dialog({title:"发送私信",quickClose:!1,width:"auto",height:"auto",content:t}),o=iCMS.$v(e,"pm");param={uid:o[0],name:o[1]},content=$("[name='content']",t).val(""),o[2]&&(param.mid=o[2]),$(".pm_warnmsg",t).hide(),$(".pm_uname",t).text(param.name),$User.INBOX_URL?$(".pm_inbox",t).attr("href",$User.INBOX_URL):$(".pm_inbox",t).hide(),$(".cancel",t).click(function(e){e.preventDefault(),i.remove()}),$('[name="send"]',t).click(function(e){return e.preventDefault(),param.content=content.val(),param.content?(param.action="pm",void $.post(n.url("user"),param,function(e){i.remove(),a.alert(e.msg,e.code)},"json")):(content.focus(),$(".pm_warnmsg",t).show(),!1)})}},REPORT:function(e){if(this.CHECK.LOGIN()){var t=$(e),i=t.attr("title")||"为什么举报这个评论?",o=document.getElementById("iCMS-REPORT-DIALOG"),r=a.dialog({title:i,content:o,quickClose:!1,width:"auto",height:"auto"});$("li",o).click(function(e){e.preventDefault(),$("li",o).removeClass("checked"),$(this).addClass("checked"),$("[name='reason']",this).prop("checked",!0)}),$(".cancel",o).click(function(e){e.preventDefault(),r.remove()}),$('[name="ok"]',o).click(function(e){e.preventDefault();var i=n.param(t),c=$("[name='content']",o);return i.reason=$("[name='reason']:checked",o).val(),i.reason?"0"!=i.reason||(i.content=c.val(),i.content)?(i.action="report",void $.post(n.url("user"),i,function(e){c.val(""),$("li",o).removeClass("checked"),$("[name='reason']",o).removeAttr("checked"),a.alert(e.msg,e.code),e.code&&r.remove()},"json")):(a.alert("请填写举报的原因"),!1):(a.alert("请选择举报的原因"),!1)})}}})});
...
define("common",function(t){var e=t("api"),a=t("utils"),i=t("user"),n=t("ui");return{__post:function(t,i,n,o){var l=this;$.post(e.url(i),t,function(e){a.callback(e,n,o,l,t)},"json")},vote:function(t,a,n){if(i.CHECK.LOGIN()){var o=iCMS.$v(t,"vote"),l=e.param(t);l=$.extend(l,{type:o[1],action:"vote"}),this.__post(l,o[0],a,n)}},favorite:function(t,a){if(i.CHECK.LOGIN()){var o='<a class="favo-list-item-link r5 " href="javascript:;" data-fid="<%=id%>"><span class="favo-list-item-title"><%=title%></span><span class="meta gray"><span class="num"><%=count%></span> 篇文章<span class="bull">•</span> <%=follow%> 人关注</span></a><div class="clearfix mt10"></div>',l=($(t),document.getElementById("iCMS-FAVORITE-DIALOG"));l.innerHTML=l.innerHTML.replace("data-src","src");var r=n.dialog({title:"添加到收藏夹",content:l,quickClose:!1,width:"auto",height:"auto"});$(".cancel",l).click(function(t){t.preventDefault(),r.remove()}),$(".create,.cancel_create",l).click(function(t){t.preventDefault(),$(this).hasClass("create")?r.title("创建新收藏夹"):r.title("添加到收藏夹"),$(".favorite_create",l).toggle(),$(".favorite_list",l).toggle()}),$('[name="create"]',l).click(function(t){t.preventDefault();var a={action:"create",title:$('[name="title"]',l).val(),description:$('[name="description"]',l).val(),mode:$('[name="mode"]:checked',l).val()};return""==a.title?($('[name="title"]',l).focus(),$(".favorite_create_error",l).text("请填写标题").show(),!1):void $.post(e.url("favorite"),a,function(t){if(t.code){var e=$.parseTmpl(o,{id:t.forward,title:a.title,count:0,follow:0});$(".favorite_list_content",l).append(e),$('[name="title"]',l).val(""),$('[name="description"]',l).val(""),$(".favorite_create",l).toggle(),$(".favorite_list",l).toggle(),r.reset()}else $(".favorite_create_error",l).text(t.msg).show()},"json")}),$.get(e.url("favorite","&do=list"),function(t){var e="";$.each(t,function(t,a){e+=$.parseTmpl(o,a)}),$(".favorite_list_content",l).html(e),r.reset()},"json"),$(l).on("click",".favo-list-item-link",function(a){var i=$(this),o=e.param(t),l=parseInt($(".num",i).text());o.fid=i.attr("data-fid"),i.hasClass("active")?o.action="delete":o.action="add",$.post(e.url("favorite"),o,function(t){t.code?i.hasClass("active")?($(".num",i).text(l-1),i.removeClass("active")):($(".num",i).text(l+1),i.addClass("active")):n.alert(t.msg)},"json")})}}}});
define("comment",function(e){var t=e("api"),n=e("ui"),a=e("user"),o=e("utils"),c={seccode:iCMS.CONFIG.COMMENT.seccode,_widget:{like_text:'<span class="text-num" i="tip:1 人觉得这个很赞"><em>1</em> <span>赞</span></span>',load_more:'<a href="javascript:;" class="load-more" i="comment_load"><span class="text">显示全部评论</a>',spinner:$('<div class="commentApp-spinner">正在加载，请稍等 <i class="spinner-lightgray"></i></div>'),_form:$('<div class="commentApp-form"><div class="commentApp-ipt"><input i="comment_content" class="commentApp-textarea form-control" type="text" placeholder="写下你的评论…"></div><div class="cmt-command"><div class="cmt-seccode"><input type="text" maxlength="4" i="comment_seccode" class="commentApp-seccode form-control" placeholder="验证码"><span class="public_seccode"><img src="'+t.url("public","&do=seccode")+'" alt="验证码" class="seccode-img r3" title="点击更换验证码图片"/><a href="javascript:;" class="seccode-text" style="float: none">换一张</a></span></div><a href="javascript:;" i="comment_put" class="btn btn-primary">评论</a><a href="javascript:;" i="comment_close"  class="cmt-command-cancel">取消</a></div><div class="clearfix"></div></div>'),item:null},page_no:{},page_total:{}};return $.extend(c,{widget:function(e,n){$.get(t.url("comment"),"&do=widget&name="+e,function(e){n(e)})},form:function(){var e=c._widget._form.clone();return"0"==c.seccode&&$(".cmt-seccode",e).remove(),e},page:function(e,t,n){var a=$(t),c=a.parent(),i=(c.parent(),c.attr("data-query")),r=iCMS.CONFIG.API+"?"+i+"&pn="+e;$.get(r,function(e){o.__callback(n,e)})},reply:function(e){if(a.CHECK.LOGIN()){var n=$(e).parent().parent(),o=t.param($(e)),i=c.form(),r=$(".commentApp-form",n);if(r.length>0)return r.remove(),!1;$(".commentApp-form",".commentApp-list").remove(),$(".commentApp-form").removeClass("expanded"),i.addClass("expanded"),$(e).parent().after(i);var m=$('[i="comment_content"]',i);m.data("param",o).focus(),$('[i="comment_close"]',i).click(function(e){e.preventDefault(),m.val(""),i.remove()})}},like:function(e,n,i){if(a.CHECK.LOGIN()){var r=this,m=$(e),p=t.param(m);r.SUCCESS=function(e,t){var n=m.parent(),a=$('[i="comment_up"]',n).text();a?(a=parseInt(a)+1,$('[i="comment_up"]',n).text(a)):n.append(c._widget.like_text)},p["do"]="like",$.get(t.url("comment"),p,function(e){o.callback(e,n,i,r)},"json")}},add:function(e,i,r,m){if(a.CHECK.LOGIN()){var p=this;if("1"==c.seccode){var s=$('[i="comment_seccode"]',e);if(i.seccode=s.val(),!i.seccode)return s.focus(),!1}var l=$('[i="comment_content"]',e);if(i.content=l.val(),!i.content)return l.focus(),!1;var d=function(e){"seccode"!=e.forward&&l.val(""),"undefined"!=typeof s&&(s.val(""),n.seccode())},f=l.data("param");"undefined"!=typeof f&&(i=$.extend(i,f)),i.action="add",$.post(t.url("comment"),i,function(e){d(e),o.callback(e,r,m,p)},"json")}},list:function(e,n,a,o){if(!a&&(c.page_no[n]++,c.page_total[n]&&c.page_no[n]>c.page_total[n]))return!1;if(o)var i=e;else var i=$(".commentApp-list",e);$.get(t.url("comment"),{"do":"json",iid:n,id:a||0,by:"ASC",page:c.page_no[n]},function(t){return c._widget.spinner.remove(),!!t&&(a||(c.page_total[n]=t[0].page.total),$.each(t,function(e,t){var n=$.parseTmpl(c._widget.item,t);"after"==o?i.after(n):"before"==o?i.before(n):"append"==o?i.append(n):i.append(n)}),void(a||($(".load-more",e).remove(),c.page_no[n]<c.page_total[n]&&i.after(c._widget.load_more))))},"json")},create:function(e){var a=$(e),o=a.parent(),i=o.parent(),r=t.param(o),m=$(".commentApp-wrap",i);if(m.length>0)return m.remove(),!1;var p=$('<i class="commentApp-icon comment-spike-icon commentApp-bubble"></i>'),s=$('<div class="commentApp-wrap">'),l=$('<div class="commentApp-list">'),d=c.form();iid=r.iid;var f=a.position(),u="createTouch"in document&&!("onmousemove"in document)||/(iPhone|iPad|iPod)/i.test(navigator.userAgent);p.css({left:u?event.offsetX:f.left,display:"inline"}),d.addClass("commentApp-wrap-ft"),s.html(c._widget.spinner),s.append(p,l,d),o.after(s),c.widget("item",function(e){c._widget.item=e}),c.page_no[iid]=0,c.page_total[iid]=0,c.list(s,iid),d.on("focus",'[i="comment_content"]',function(e){e.preventDefault();var t=$(this).parent().parent();$(".commentApp-form").not(t).remove(),t.addClass("expanded")}).on("click",'[i="comment_close"]',function(e){e.preventDefault();var t=$(this).parent().parent();t.removeClass("expanded"),$('[i="comment_content"]',t).val("")}),s.on("click",'[i="comment_load"]',function(e){e.preventDefault(),$(".load-more",l).remove(),c.list(s,iid)}).on("click",'[i="comment_put"]',function(e){e.preventDefault();var t=$(this),o=t.parent().parent();c.add(o,r,function(e){var n=parseInt($('[i="comment_num"]',a).text());$('[i="comment_num"]',a).text(n+1);var o=t.parents(".commentApp-item");if(o.length)var i="after";else var o=t.parents(".commentApp-wrap"),i=null;c.list(o,iid,e.forward,i)},function(e){n.alert(e.msg)})}).on("click",'[i="comment_reply"]',function(e){e.preventDefault(),c.reply(this)}).on("click",'[i="comment_like"]',function(e){e.preventDefault(),c.like(this)})}})});
window.iCMS={version:"6.2.0",plugins:{},modules:{},data:{},UI:{},API:require("api"),$:function(i,r){var r=r||document;return $("[i="+i+"]",$(r))},$v:function(i,r){var e=$(i).attr("i").replace(r+":","");return e.split(":")},init:function(i){var r=require("config");iCMS.CONFIG=$.extend(r,i),iCMS.CONFIG.API=iCMS.CONFIG.PUBLIC+"/api.php",iCMS.UI=require("ui"),iCMS.dialog=iCMS.UI.dialog,iCMS.alert=iCMS.UI.alert},run:function(i,r){var e=require(i);return"function"==typeof r?r(e):e}};
