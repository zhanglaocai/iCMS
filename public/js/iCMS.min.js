...
define("user",function(e){var t=e("utils"),n=e("api"),a={INBOX_URL:iCMS.CONFIG.API+"?app=user&do=manage&pg=inbox"};return $.extend(a,{NOAVATAR:function(e){e.src=iCMS.CONFIG.PUBLIC+"/ui/avatar.gif"},NOCOVER:function(e,t){var n="coverpic";"m"==t&&(n="m_coverpic"),e.src=iCMS.CONFIG.PUBLIC+"/ui/"+n+".jpg"},STATUS:function(e,i,o){var r=this;$.get(n.url("user","&do=data"),e,function(e){e.code&&(a.data=e),t.callback(e,i,o,r)},"json")},AUTH:function(){var t=e("cookie");return!!t.get(iCMS.CONFIG.AUTH)},UHOME:function(e){return iCMS.CONFIG.UHOME.replace("{uid}",e)},LOGIN:function(){},LOGOUT:function(e,a,i){var o=this;$.get(n.url("user","&do=logout"),e,function(e){t.callback(e,a,i,o)},"json")},FOLLOW:function(e,a,i){var o=this,r=this.AUTH();if(!r)return this.LOGIN();var c=$(e).attr("i").replace("follow:","").split(":"),u={uid:c[0],follow:c[1],action:"follow"};$.post(n.url("user"),u,function(e){t.callback(e,a,i,o,u)},"json")},UCARD:function(){var t=e("ui");e("poshytip");$("[i^='ucard']").poshytip({idName:"iCMS-UCARD",className:"iCMS_UI_TOOLTIP",alignTo:"target",alignX:"center",offsetX:0,offsetY:5,fade:!1,slide:!1,content:function(e){var a=$(this).attr("i").replace("ucard:","");return a&&$.get(n.url("user","&do=ucard"),{uid:a},e),t.widget.ucard}})},PM:function(t){var i=this.AUTH();if(!i)return this.LOGIN();var o=e("ui"),r=($(t),document.getElementById("iCMS-PM-DIALOG")),c=o.dialog({title:"发送私信",quickClose:!1,width:"auto",height:"auto",content:r}),u=iCMS.$v(t,"pm");param={uid:u[0],name:u[1]},content=$("[name='content']",r).val(""),u[2]&&(param.mid=u[2]),$(".pm_warnmsg",r).hide(),$(".pm_uname",r).text(param.name),a.INBOX_URL?$(".pm_inbox",r).attr("href",a.INBOX_URL):$(".pm_inbox",r).hide(),$(".cancel",r).click(function(e){e.preventDefault(),c.remove()}),$('[name="send"]',r).click(function(e){return e.preventDefault(),param.content=content.val(),param.content?(param.action="pm",void $.post(n.url("user"),param,function(e){c.remove(),o.alert(e.msg,e.code)},"json")):(content.focus(),$(".pm_warnmsg",r).show(),!1)})},REPORT:function(t){var a=this.AUTH();if(!a)return this.LOGIN();var i=e("ui"),o=$(t),r=o.attr("title")||"为什么举报这个评论?",c=document.getElementById("iCMS-REPORT-DIALOG"),u=i.dialog({title:r,content:c,quickClose:!1,width:"auto",height:"auto"});$("li",c).click(function(e){e.preventDefault(),$("li",c).removeClass("checked"),$(this).addClass("checked"),$("[name='reason']",this).prop("checked",!0)}),$(".cancel",c).click(function(e){e.preventDefault(),u.remove()}),$('[name="ok"]',c).click(function(e){e.preventDefault();var t=n.param(o),a=$("[name='content']",c);return t.reason=$("[name='reason']:checked",c).val(),t.reason?"0"!=t.reason||(t.content=a.val(),t.content)?(t.action="report",void $.post(n.url("user"),t,function(e){a.val(""),$("li",c).removeClass("checked"),$("[name='reason']",c).removeAttr("checked"),i.alert(e.msg,e.code),e.code&&u.remove()},"json")):(i.alert("请填写举报的原因"),!1):(i.alert("请选择举报的原因"),!1)})}})});
