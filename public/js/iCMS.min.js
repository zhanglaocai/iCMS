...
define("config",{API:"/api.php",PUBLIC:"/public/",COOKIE:"iCMS_",AUTH:"USER_AUTH",DIALOG:[],APP:"iCMS"});
...
window.iCMS={plugins:{},modules:{},version:"6.2.0",UI:require("ui"),API:require("api"),init:function(i){var e=require("config");iCMS.CONFIG=$.extend(e,i),iCMS.CONFIG.API=iCMS.CONFIG.PUBLIC+"/api.php"},run:function(i,e){var n=require(i);return"function"==typeof e?e(n):n}};