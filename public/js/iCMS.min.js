...
iCMS.define("comment",function(){var e=iCMS.require("api"),n=iCMS.require("ui"),t=iCMS.require("user"),a=iCMS.require("utils"),o={seccode:iCMS.CONFIG.COMMENT.seccode,widget:{like:'<span class="text-num" i="tip:1 人觉得这个很赞"><em>1</em> <span>赞</span></span>',more:'<a href="javascript:;" class="load-more" i="comment_load"><span class="text">显示全部评论</a>',spinner:$('<div class="commentApp-spinner">正在加载，请稍等 <i class="spinner-lightgray"></i></div>'),item:null},page_no:{},page_total:{},container:{}};return $.extend(o,{template:function(n,t){return o.container[n]?t(o.container[n]):void $.get(e.url("comment"),"&do=widget&name="+n,function(e){o.container[n]=e,t(e)})},miniForm:function(e){o.template("mini.form",function(n){var t=$(n);t.on("focus",'[i="comment_content"]',function(e){e.preventDefault(),t.addClass("expanded")}).on("click",'[i="comment_close"]',function(e){e.preventDefault(),t.removeClass("expanded"),$('[i="comment_content"]',t).val("")}),e&&a.__callback(e,t)})},page:function(e,n,t){var o=$(n),i=o.parent(),c=(i.parent(),i.attr("data-query")),r=iCMS.CONFIG.API+"?"+c+"&pn="+e;$.get(r,function(e){a.__callback(t,e)})},reply:function(n){if(t.CHECK.LOGIN()){var a=$(n).parent().parent(),i=e.param($(n)),c=$(".commentApp-form",a);if(c.length>0)return c.remove(),!1;$(".commentApp-form",".commentApp-list").remove(),$(".commentApp-form").removeClass("expanded"),o.miniForm(function(e){e.addClass("expanded"),$('[i="comment_close"]',e).click(function(n){n.preventDefault();var t=$('[i="comment_content"]',e);t.data("param",i).focus(),t.val(""),e.remove()}),$(n).parent().after(e)})}},like:function(n,i,c){if(t.CHECK.LOGIN()){var r=this,m=$(n),p=e.param(m);r.SUCCESS=function(e,n){var t=m.parent(),a=$('[i="comment_up"]',t).text();a?(a=parseInt(a)+1,$('[i="comment_up"]',t).text(a)):t.append(o.widget.like)},p["do"]="like",$.get(e.url("comment"),p,function(e){a.callback(e,i,c,r)},"json")}},add:function(i,c,r,m){if(t.CHECK.LOGIN()){var p=this;if("1"==o.seccode){var l=$('[i="comment_seccode"]',i);if(c.seccode=l.val(),!c.seccode)return l.focus(),!1}var s=$('[i="comment_content"]',i);if(c.content=s.val(),!c.content)return s.focus(),!1;var f=function(e){"seccode"!=e.forward&&s.val(""),"undefined"!=typeof l&&(l.val(""),n.seccode())},u=s.data("param");"undefined"!=typeof u&&(c=$.extend(c,u)),c.action="add",$.post(e.url("comment"),c,function(e){f(e),a.callback(e,r,m,p)},"json")}},list:function(n,t,a,i){if(!a&&(o.page_no[t]++,o.page_total[t]&&o.page_no[t]>o.page_total[t]))return!1;if(i)var c=n;else var c=$(".commentApp-list",n);$.get(e.url("comment"),{"do":"json",iid:t,id:a||0,by:"ASC",page:o.page_no[t]},function(e){return o.widget.spinner.remove(),!!e&&(a||(o.page_total[t]=e[0].page.total),$.each(e,function(e,n){var t=$.parseTmpl(o.widget.item,n);"after"==i?c.after(t):"before"==i?c.before(t):"append"==i?c.append(t):c.append(t)}),void(a||($(".load-more",n).remove(),o.page_no[t]<o.page_total[t]&&c.after(o.widget.more))))},"json")},create:function(t){var a=$(t),i=a.parent(),c=i.parent(),r=e.param(i),m=$(".commentApp-wrap",c);if(m.length>0)return m.remove(),!1;var p=$('<i class="commentApp-icon comment-spike-icon commentApp-bubble"></i>'),l=$('<div class="commentApp-wrap">'),s=$('<div class="commentApp-list">'),f=r.iid,u=a.position(),d="createTouch"in document&&!("onmousemove"in document)||/(iPhone|iPad|iPod)/i.test(navigator.userAgent);p.css({left:d?event.offsetX:u.left,display:"inline"}),l.html(o.widget.spinner),l.append(p,s),o.miniForm(function(e){e.addClass("commentApp-wrap-ft"),l.append(e)}),i.after(l),o.template("item",function(e){o.widget.item=e,o.page_no[f]=0,o.page_total[f]=0,o.list(l,f)}),l.on("click",'[i="comment_load"]',function(e){e.preventDefault(),$(".load-more",s).remove(),o.list(l,f)}).on("click",'[i="comment_put"]',function(e){e.preventDefault();var t=$(this),i=t.parent().parent();o.add(i,r,function(e){var n=parseInt($('[i="comment_num"]',a).text());$('[i="comment_num"]',a).text(n+1);var i=t.parents(".commentApp-item");if(i.length)var c="after";else var i=t.parents(".commentApp-wrap"),c=null;o.list(i,f,e.forward,c)},function(e){n.alert(e.msg)})}).on("click",'[i="comment_reply"]',function(e){e.preventDefault(),o.reply(this)}).on("click",'[i="comment_like"]',function(e){e.preventDefault(),o.like(this)})}})});
