...
define("ui.dialog",function(o){var e=o("artdialog");return function(o,i){function n(o){window.clearTimeout(c),"function"==typeof i&&i(o)}function t(o){return'<table class="ui-dialog-table" align="center"><tr><td valign="middle"><div class="iPHP-msg"><span class="label label-'+a.label+'"><i class="fa fa-'+a.icon+'"></i> '+o+"</span></div></td></tr></table>"}var l={id:"iCMS-DIALOG",title:"iCMS - 提示信息",className:"iCMS_UI_DIALOG",backdropBackground:"#333",backdropOpacity:.5,fixed:!0,autofocus:!1,quickClose:!0,lock:!0,time:null,label:"success",icon:"check",api:!1,width:360,height:120},c=null,a=$.extend(l,iCMS.CONFIG.DIALOG,o);a.follow&&(a.fixed=!1,a.lock=!1,a.skin="iCMS_tooltip_popup",a.className="ui-popup",a.backdropOpacity=0);var s=a.content;s instanceof jQuery?a.content=s:"string"==typeof s&&(a.content=t(s)),a.onclose=function(){n("close")},a.onbeforeremove=function(){n("beforeremove")},a.onremove=function(){n("remove")};var r=e(a);return a.lock?r.showModal():(r.show(a.follow),a.follow),a.time&&(c=window.setTimeout(function(){r.destroy()},a.time)),r.destroy=function(){r.close().remove()},r}});
define("ui",{widget:{ucard:['<div class="tip_info">','<img src="'+require("config").PUBLIC+'/ui/loading.gif">',"<span> 用户信息加载中……</span>","</div>"].join("")},dialog:function(i){var e=require("ui.dialog");return e(i)},alert:function(i,e,t){var h=require("ui.dialog"),r=e?{label:"success",icon:"check"}:{label:"warning",icon:"warning"};r.id="iCMS-DIALOG-ALERT",r.skin="iCMS_dialog_alert",r.content=i,r.time=3e3,r.lock=!0,h(r,t)},seccode:function(i,e){var t=require("api"),i=i||".seccode-img",e=e||"body";$(i,e).attr("src",t.url("public","&do=seccode&")+Math.random())},imgFix:function(i,e,t){e=e||99999,t=t||99999,i.removeAttribute("width"),i.removeAttribute("height"),i.width/i.height>e/t&&i.width>e?(i.height=i.height*(e/i.width),i.width=e,i.parentNode.style.height=i.height*(e/i.width)+"px"):i.width/i.height<=e/t&&i.height>t&&(i.width=i.width*(t/i.height),i.height=t,i.parentNode.style.height=t+"px")}});
...
define("user",function(e){var t=e("utils"),n=e("api"),a=e("ui");return User={INBOX_URL:iCMS.CONFIG.API+"?app=user&do=manage&pg=inbox"},$.extend(User,{NOAVATAR:function(e){e.src=iCMS.CONFIG.PUBLIC+"/ui/avatar.gif"},NOCOVER:function(e,t){var n="coverpic";"m"==t&&(n="m_coverpic"),e.src=iCMS.CONFIG.PUBLIC+"/ui/"+n+".jpg"},STATUS:function(e,a,r){var o=this;$.get(n.url("user","&do=data"),e,function(e){e.code&&(User.data=e),t.callback(e,a,r,o)},"json")},AUTH:function(){var t=e("cookie");return!!t.get(iCMS.CONFIG.AUTH)},UHOME:function(e){return iCMS.CONFIG.UHOME.replace("{uid}",e)},LOGIN:function(){},LOGOUT:function(e,a,r){var o=this;$.get(n.url("user","&do=logout"),e,function(e){t.callback(e,a,r,o)},"json")},FOLLOW:function(e,a,r){var o=this,i=this.AUTH();if(!i)return this.LOGIN();var c=$(e).attr("i").replace("follow:","").split(":"),u={uid:c[0],follow:c[1],action:"follow"};$.post(n.url("user"),u,function(e){t.callback(e,a,r,o,u)},"json")},UCARD:function(){e("poshytip");$("[i^='ucard']").poshytip({idName:"iCMS-UCARD",className:"iCMS_UI_TOOLTIP",alignTo:"target",alignX:"center",offsetX:0,offsetY:5,fade:!1,slide:!1,content:function(e){var t=$(this).attr("i").replace("ucard:","");return t&&$.get(n.url("user","&do=ucard"),{uid:t},e),a.widget.ucard}})},PM:function(e){var t=this.AUTH();if(!t)return this.LOGIN();var r=($(e),document.getElementById("iCMS-PM-DIALOG")),o=a.dialog({title:"发送私信",quickClose:!1,width:"auto",height:"auto",content:r}),i=iCMS.$v(e,"pm");param={uid:i[0],name:i[1]},content=$("[name='content']",r).val(""),i[2]&&(param.mid=i[2]),$(".pm_warnmsg",r).hide(),$(".pm_uname",r).text(param.name),User.INBOX_URL?$(".pm_inbox",r).attr("href",User.INBOX_URL):$(".pm_inbox",r).hide(),$(".cancel",r).click(function(e){e.preventDefault(),o.remove()}),$('[name="send"]',r).click(function(e){return e.preventDefault(),param.content=content.val(),param.content?(param.action="pm",void $.post(n.url("user"),param,function(e){o.remove(),a.alert(e.msg,e.code)},"json")):(content.focus(),$(".pm_warnmsg",r).show(),!1)})},REPORT:function(e){var t=this.AUTH();if(!t)return this.LOGIN();var r=$(e),o=r.attr("title")||"为什么举报这个评论?",i=document.getElementById("iCMS-REPORT-DIALOG"),c=a.dialog({title:o,content:i,quickClose:!1,width:"auto",height:"auto"});$("li",i).click(function(e){e.preventDefault(),$("li",i).removeClass("checked"),$(this).addClass("checked"),$("[name='reason']",this).prop("checked",!0)}),$(".cancel",i).click(function(e){e.preventDefault(),c.remove()}),$('[name="ok"]',i).click(function(e){e.preventDefault();var t=n.param(r),o=$("[name='content']",i);return t.reason=$("[name='reason']:checked",i).val(),t.reason?"0"!=t.reason||(t.content=o.val(),t.content)?(t.action="report",void $.post(n.url("user"),t,function(e){o.val(""),$("li",i).removeClass("checked"),$("[name='reason']",i).removeAttr("checked"),a.alert(e.msg,e.code),e.code&&c.remove()},"json")):(a.alert("请填写举报的原因"),!1):(a.alert("请选择举报的原因"),!1)})}})});
...
define("common",function(t){var e=t("api"),a=t("utils");return{__post:function(t,i,n,o){var l=this;$.post(e.url(i),t,function(e){a.callback(e,n,o,l,t)},"json")},vote:function(t,a,i){var n=iCMS.$v(t,"vote"),o=e.param(t);o=$.extend(o,{type:n[1],action:"vote"}),this.__post(o,n[0],a,i)},favorite:function(a,i){function n(t){return'<a class="favo-list-item-link r5 " href="javascript:;" data-fid="'+t.id+'"><span class="favo-list-item-title">'+t.title+'</span><span class="meta gray"><span class="num">'+t.count+'</span> 篇文章<span class="bull">•</span> '+t.follow+' 人关注</span></a><div class="clearfix mt10"></div>'}var o=t("user"),l=t("ui"),r=o.AUTH();if(!r)return o.LOGIN();var c=($(a),document.getElementById("iCMS-FAVORITE-DIALOG")),s=l.dialog({title:"添加到收藏夹",content:c,quickClose:!1,width:"auto",height:"auto"});$(".favorite_list_content",c).empty(),$(".cancel",c).click(function(t){t.preventDefault(),s.remove()}),$(".create,.cancel_create",c).click(function(t){t.preventDefault(),$(this).hasClass("create")?s.title("创建新收藏夹"):s.title("添加到收藏夹"),$(".favorite_create",c).toggle(),$(".favorite_list",c).toggle()}),$('[name="create"]',c).click(function(t){t.preventDefault();var a={action:"create",title:$('[name="title"]',c).val(),description:$('[name="description"]',c).val(),mode:$('[name="mode"]:checked',c).val()};return""==a.title?($('[name="title"]',c).focus(),$(".favorite_create_error",c).text("请填写标题").show(),!1):void $.post(e.url("favorite"),a,function(t){if(t.code){var e=n({id:t.forward,title:a.title,count:0,follow:0});$(".favorite_list_content",c).append(e),$('[name="title"]',c).val(""),$('[name="description"]',c).val(""),$(".favorite_create",c).toggle(),$(".favorite_list",c).toggle(),s.reset()}else $(".favorite_create_error",c).text(t.msg).show()},"json")}),$.get(e.url("favorite","&do=list"),function(t){var e="";$.each(t,function(t,a){e+=n(a)}),$(".favorite_list_content",c).html(e),s.reset()},"json"),$(c).on("click",".favo-list-item-link",function(t){var i=$(this),n=e.param(a),o=parseInt($(".num",i).text());n.fid=i.attr("data-fid"),i.hasClass("active")?n.action="delete":n.action="add",$.post(e.url("favorite"),n,function(t){t.code?i.hasClass("active")?($(".num",i).text(o-1),i.removeClass("active")):($(".num",i).text(o+1),i.addClass("active")):l.alert(t.msg)},"json")})}}});
window.iCMS={version:"6.2.0",plugins:{},modules:{},data:{},UI:{},API:require("api"),$:function(i,r){var r=$(r)||$(document);return r.find("[i="+i+"]")},$v:function(i,r){var n=$(i).attr("i").replace(r+":","");return n.split(":")},init:function(i){var r=require("config");iCMS.CONFIG=$.extend(r,i),iCMS.CONFIG.API=iCMS.CONFIG.PUBLIC+"/api.php",iCMS.UI=require("ui"),iCMS.dialog=iCMS.UI.dialog,iCMS.alert=iCMS.UI.alert},run:function(i,r){var n=require(i);return"function"==typeof r?r(n):n}};
