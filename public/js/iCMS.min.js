...
define("user",function(i){var t=i("utils"),n=i("api"),a={};return $.extend(a,{NOAVATAR:function(i){i.src=iCMS.CONFIG.PUBLIC+"/ui/avatar.gif"},NOCOVER:function(i,t){var n="coverpic";"m"==t&&(n="m_coverpic"),i.src=iCMS.CONFIG.PUBLIC+"/ui/"+n+".jpg"},STATUS:function(i,a,r){var c=this;$.get(n.url("user","&do=data"),i,function(i){t.callback(i,a,r,c)},"json")},AUTH:function(){var t=i("cookie");return!!t.get(iCMS.CONFIG.AUTH)},LOGOUT:function(i,a,r){var c=this;$.get(n.url("user","&do=logout"),i,function(i){t.callback(i,a,r,c)},"json")},FOLLOW:function(i,a,r){var c=this,o=this.AUTH();if(!o)return t.__callback(r,c);var u=n.param(i);u.action="follow",$.post(n.url("user"),u,function(i){t.callback(i,a,a,c,u)},"json")},UCARD:function(){i("poshytip"),$("[i^='ucard']").poshytip({className:"iCMS_UI_TOOLTIP",alignTo:"target",alignX:"center",offsetX:0,offsetY:5,fade:!1,slide:!1,content:function(i){var t=$(this).attr("i").replace("ucard:","");if(t)return $.get(n.url("user","&do=ucard"),{uid:t},i),'<div class="tip_info"><img src="'+iCMS.CONFIG.PUBLIC+'/ui/loading.gif"><span> 用户信息加载中……</span></div>'}})}})});
...
window.iCMS={version:"6.2.0",plugins:{},modules:{},UI:{},API:require("api"),init:function(i){var e=require("config");iCMS.CONFIG=$.extend(e,i),iCMS.CONFIG.API=iCMS.CONFIG.PUBLIC+"/api.php",iCMS.UI=require("ui"),iCMS.dialog=iCMS.UI.dialog,iCMS.alert=iCMS.UI.alert},run:function(i,e){var r=require(i);return"function"==typeof e?e(r):r}};
