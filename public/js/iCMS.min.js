...
iCMS.define("ui.dialog",function(o){var e=iCMS.require("artdialog");return function(o,i){function n(o){window.clearTimeout(c),"function"==typeof i&&i(o)}function t(o){return'<table class="ui-dialog-table" align="center"><tr><td valign="middle"><div class="iPHP-msg"><span class="label label-'+a.label+'"><i class="fa fa-'+a.icon+'"></i> '+o+"</span></div></td></tr></table>"}var l={id:"iCMS-DIALOG",title:"iCMS - 提示信息",className:"iCMS_UI_DIALOG",backdropBackground:"#333",backdropOpacity:.5,fixed:!0,autofocus:!1,quickClose:!0,lock:!0,time:null,label:"success",icon:"check",api:!1},c=null,a=$.extend(l,iCMS.CONFIG.DIALOG,o);a.follow&&(a.fixed=!1,a.lock=!1,a.skin="iCMS_tooltip_popup",a.className="ui-popup",a.backdropOpacity=0);var r=a.content;r instanceof jQuery?a.content=r:"string"==typeof r&&(a.content=t(r)),a.onclose=function(){n("close")},a.onbeforeremove=function(){n("beforeremove")},a.onremove=function(){n("remove")};var s=e(a);return a.lock?s.showModal():(s.show(a.follow),a.follow),a.time&&(c=window.setTimeout(function(){s.destroy()},a.time)),s.destroy=function(){s.close().remove()},s}});
iCMS.define("ui",{dialog:function(i){var e=iCMS.require("ui.dialog");return e(i)},alert:function(i,e,c){var r=iCMS.require("ui.dialog"),n=e?{label:"success",icon:"check"}:{label:"warning",icon:"warning"};n.id="iCMS-DIALOG-ALERT",n.skin="iCMS_dialog_alert",n.content=i,n.time=3e3,n.lock=!0,r(n,c)},seccode:function(i,e){var c=iCMS.require("api"),i=i||".seccode-img",e=e||"body";$(i,e).attr("src",c.url("public","&do=seccode&")+Math.random())}});
...
window.iCMS=$.extend(window.iCMS,{API:iCMS.require("api"),init:function(i){var C=iCMS.require("config");iCMS.CONFIG=$.extend(C,i),iCMS.CONFIG.API=iCMS.CONFIG.PUBLIC+"/api.php",iCMS.UI=iCMS.require("ui"),iCMS.FORMER=iCMS.require("former"),iCMS.dialog=iCMS.UI.dialog,iCMS.alert=iCMS.UI.alert}});
