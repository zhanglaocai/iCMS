...
window.iCMS=$.extend(window.iCMS,{API:iCMS.require("api"),init:function(i){var C=iCMS.require("config");iCMS.CONFIG=$.extend(C,i),iCMS.CONFIG.API=iCMS.CONFIG.PUBLIC+"/api.php",iCMS.UI=iCMS.require("ui"),iCMS.FORMER=iCMS.require("former"),iCMS.dialog=iCMS.UI.dialog,iCMS.alert=iCMS.UI.alert}}),function(i){i.fn.param=function(){return window.iCMS.API.param(this)}}(jQuery);
