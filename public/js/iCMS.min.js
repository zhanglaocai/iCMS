...
window.iCMS={version:"7.0.0",plugins:{},modules:{},data:{},UI:{},API:{},$:function(e,r){var r=r||document;return $("[i="+e+"]",$(r))},$v:function(e,r){var n=$(e).attr("i").replace(r+":","");return n.split(":")},require:function(e){var r=iCMS.modules[e],n="exports";return"object"==typeof r?r:(r[n]||(r[n]={},r[n]=r.call(r[n],iCMS.require,r[n],r)||r[n]),r[n])},define:function(e,r){iCMS.modules[e]=r},run:function(e,r){var n=iCMS.require(e);return"function"==typeof r?r(n):n}};
...
window.iCMS=$.extend(window.iCMS,{API:iCMS.require("api"),init:function(i){var C=this.require("config");iCMS.CONFIG=$.extend(C,i),iCMS.CONFIG.API=iCMS.CONFIG.PUBLIC+"/api.php",iCMS.UI=this.require("ui"),iCMS.FORMER=this.require("former"),iCMS.dialog=iCMS.UI.dialog,iCMS.alert=iCMS.UI.alert}});
