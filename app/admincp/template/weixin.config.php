  ...
  <div id="config-weixin" class="tab-pane hide">
    ...
    <div id="wxmp_interface">
      <div class="input-prepend input-append">
        ...
        <input disabled type="text" class="span7" id="weixin_interface" value="<?php echo iCMS::$config['router']['public'] ; ?>/api.php?app=weixin&do=interface&api_token=<?php echo $config['api']['weixin']['token']?$config['api']['weixin']['token']:'Token(令牌)' ; ?>"/>
