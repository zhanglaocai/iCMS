...
$(function(){
    $("#tree").treeview({
    	url:'<?php echo $this->category_uri; ?>&do=ajaxtree&expanded=<?php echo iACP::$app_do=='all'?'1':'0';?>',
        collapsed: false,
        sortable: true,
        animated: "medium",
        control:"#treecontrol",
  ...
  <div class="widget-box" id="<?php echo APP_BOXID;?>">
    <div class="widget-title"> <span class="icon"> <i class="fa fa-list"></i> </span>
      <ul class="nav nav-tabs" id="category-tab">
        <li<?php if(iACP::$app_do=='tree'){ ?> class="active" <?php } ?>><a href="<?php echo $this->category_uri; ?>&do=tree"><i class="fa fa-tasks"></i> 树模式</a></li>
        <li<?php if(iACP::$app_do=='list'){ ?> class="active" <?php } ?>><a href="<?php echo $this->category_uri; ?>&do=list"><i class="fa fa-list"></i> 列表模式</a></li>
      </ul>
    </div>
