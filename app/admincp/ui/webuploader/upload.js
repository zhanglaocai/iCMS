(function( $ ){
    ...
    $(function() {
        var $wrap = $('#uploader'),
            ...
            $progress = $statusBar.find( '.progressBar' ).hide(),
            // 添加的文件数量
            fileCount = 0,
            // 添加的文件总大小
            fileSize = 0,
        ...
        function addFile( file ) {
            var $li = $( '<li id="' + file.id + '">' +
                    ...
                    '<p class="imgWrap"></p>'+
                    '<p class="progressWrap"><span></span></p>' +
                    '</li>' ),
                ...
                $prgress = $li.find('p.progressWrap span'),
        ...
        function updateTotalProgress() {
            ...
            //$(".bar",$progress).css( 'width', Math.round( percent * 100 ) + '%' );
            updateStatus();
        }
        ...
        function updateStatus() {
            ...
            if ( state === 'ready' ) {
                ...
                $("#FilesUploaded").text(stats.successNum +'个文件已上传')
                if ( stats.uploadFailNum ) {
        ...
        uploader.onUploadProgress = function( file, percentage ) {
            var $li = $('#'+file.id),
                $percent = $li.find('.progressWrap span');
