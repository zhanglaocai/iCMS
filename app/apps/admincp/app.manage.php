...
<div class="iCMS-container">
      ...
      <form action="<?php echo iPHP_SELF ; ?>" method="get" class="form-inline">
        ...
        <div class="input-prepend input-append">
          ...
          <select name="cid" id="cid" class="chosen-select" style="width: 230px;">
            ...
            <?php echo $category_select = $categoryAdmincp->select('cs') ; ?>
          </select>
          <span class="add-on">
  ...
  <div class="widget-box" id="<?php echo APP_BOXID;?>">
    ...
    <div class="widget-content nopadding">
      <form action="<?php echo APP_FURI; ?>&do=app_batch" method="post" class="form-inline" id="<?php echo APP_FORMID;?>" target="iPHP_FRAME">
          ...
          ?>
            <tr id="tr<?php echo $id; ?>">
              ...
              <td>
                ...
                <a href="<?php echo APP_FURI; ?>&do=app_update&id=<?php echo $id ; ?>&_args=status:0" class="btn btn-small" target="iPHP_FRAME"><i class="fa fa-power-off"></i> 禁用</a>
                <?php } ?>
                <?php if($rs[$i]['status']=="0"){ ?>
                <a href="<?php echo APP_FURI; ?>&do=app_update&id=<?php echo $id ; ?>&_args=status:1" class="btn btn-small" target="iPHP_FRAME"><i class="fa fa-play-circle"></i> 启用</a>
                <?php } ?>
                <a href="<?php echo APP_URI; ?>&do=app_add&id=<?php echo $id ; ?>" class="btn btn-small"><i class="fa fa-edit"></i> 编辑</a>
                <a href="<?php echo APP_FURI; ?>&do=app_del&id=<?php echo $id ; ?>" target="iPHP_FRAME" class="del btn btn-small btn-danger fr" title='永久删除'  onclick="return confirm('确定要删除?');"/><i class="fa fa-trash-o"></i> 删除</a>
              </td>
            </tr>
            <?php }  ?>
          </tbody>
