...
var iFormer ={
  ...
  render:function (a) {
    ...
    var $span = $('<span class="add-on" />');
    var $ele  = this.element(a.field);
  ...
  $( function() {
    $( "#custom_field_list" ).sortable({
      ...
      receive:function(event, ui){
        ...
        var field = helper.attr('fieldtype');
        var id = iCMS.random(5);
        var code = iFormer.render({
          'id':id,
          'text':'表单'+id,
          'name':'iformer['+id+']',
          'field':field,
        ...
        helper.replaceWith(code);

        // if(type=='row'){
        //   helper.replaceWith('<div class="row-fluid"><div class="span12"></div></div>');
        // }
        // if(type=='col2'){
        //   helper.replaceWith('<div class="row-fluid"><div class="span6"></div><div class="span6"></div></div>');
        // }
        // if(type=='col3'){
        //   helper.replaceWith('<div class="row-fluid"><div class="span4"></div><div class="span4"></div><div class="span4"></div></div>');
        // }
        // if(type=='input'){
        //   helper.replaceWith('<div class="input-prepend"> <span class="add-on">表单</span>'+
        //                 '<input type="text" name="title" class="span3" id="title" value="">'+
        //               '</div> ')
        // }
        // if(type=='blank'){
        //   helper.replaceWith('<div class="clearfloat"></div>')
        // }
        // if(type=='textarea'){
        //   helper.replaceWith('<div class="input-prepend" style="width:100%;"><span class="add-on">摘 要</span>'+
        //       '<textarea name="description" id="description" class="span6" style="height: 150px;"></textarea>'+
        //     '</div>')
        // }
      //   // item.remove();
    ...
    // $( "#custom_field_list .alert" ).sortable({
    //   placeholder: "ui-state-highlight",
    //   connectWith: ".alert",
    //   // revert: true,
    //   // helper: "clone",
    ...
    //     var  helper = ui.helper;
    //     var type = $(helper).attr('fieldtype');

    //     // helper.html('<div class="input-prepend"> <span class="add-on">标 题</span>'+
    //     //       '<input type="text" name="title" class="span6" id="title" value="">'+
    //     //     '</div>');
    //     if(type=='row'){
    //       $("#custom_field_list").append('<div class="row-fluid"><div class="span12 alert"></div></div>');
    //     }
    //     if(type=='col2'){
    //       $("#custom_field_list").append('<div class="row-fluid"><div class="span6 alert"></div><div class="span6 alert"></div></div>');
    //     }
    //     if(type=='col3'){
    //       $("#custom_field_list").append('<div class="row-fluid"><div class="span4 alert"></div><div class="span4 alert"></div><div class="span4 alert"></div></div>');
    //     }
    //     helper.remove();
    //     console.log(type);
    //   }
