...
return '{
    ...
    "3": "UI:BR",
    "ucid": "id=ucid&label=用户分类&field=INT&name=ucid&default=&type=user_category&len=10&class=span3",
    "5": "UI:BR",
    "pid": "id=pid&label=属性&field=VARCHAR&name=pid&type=multi_prop&default=&len=255&class=span3",
    "7": "UI:BR",
