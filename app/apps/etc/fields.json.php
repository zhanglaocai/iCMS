...
return '{
    "id": "id=id&label=内容id&comment=主键%20自增ID&field=INT&name=id&default=&type=PRIMARY&len=10&class=span2",
    "1": "UI:BR",
    "cid": "id=cid&label=栏目id&field=INT&name=cid&default=&type=category&len=10&class=span3",
    "3": "UI:BR",
    "ucid": "id=ucid&label=用户分类&field=INT&name=ucid&default=&type=hidden&len=10&class=span3",
    "5": "UI:BR",
    "title": "id=title&label=标题&field=VARCHAR&name=title&type=text&default=&len=255&class=span6",
    "7": "UI:BR",
    "pid": "id=pid&label=属性&field=VARCHAR&name=pid&type=multiprop&default=&len=255&class=span3",
    "9": "UI:BR",
    "editor": "id=editor&label=编辑&comment=编辑或用户名&field=VARCHAR&name=editor&type=username&default=&len=255&class=span3",
    "11": "UI:BR",
    "userid": "id=userid&label=用户ID&field=INT&name=userid&type=userid&default=&len=10&class=span2",
    "13": "UI:BR",
    "pubdate": "id=pubdate&label=发布时间&field=INT&name=pubdate&default=&type=datetime&len=10&class=span3",
    "15": "UI:BR",
    "postime": "id=postime&label=提交时间&field=INT&name=postime&default=&type=hidden&len=10&class=span3",
    "17": "UI:BR",
