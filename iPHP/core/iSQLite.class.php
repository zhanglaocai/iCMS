...
class iDB{
    ...
    public static function connect() {
		...
		try {
		    ...
		    self::bail("<h1>数据库链接失败</h1><p>[Error] " . $ex->getMessage() . "</p>");
		}
        self::$link OR self::bail("<h1>数据库链接失败</h1><p>请检查 <em><strong>config.php</strong></em> 的配置是否正确!</p><ul><li>请确认主机支持SQLite3?</li><li>请确认用户名和密码正确?</li><li>请确认SQLite数据库是否存在?(一般在core目录下)</li></ul><p>如果你不确定这些情况,请询问你的主机提供商.如果你还需要帮助你可以随时浏览 <a href='http://www.iiiphp.com'>iPHP 支持论坛</a>.</p>");
