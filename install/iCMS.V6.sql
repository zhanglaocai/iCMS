...
INSERT INTO `#iCMS@__menu` (`rootid`, `ordernum`, `app`, `name`, `title`, `href`, `icon`, `class`, `a_class`, `target`, `caret`, `data-toggle`, `data-meta`, `data-target`) values('6','1','separator','','','','','divider','','','','','','');
INSERT INTO `#iCMS@__menu` (`rootid`, `ordernum`, `app`, `name`, `title`, `href`, `icon`, `class`, `a_class`, `target`, `caret`, `data-toggle`, `data-meta`, `data-target`) values('6','13','marker','添加标记','','marker&do=add','fa fa-edit','','','','','','','');
INSERT INTO `#iCMS@__menu` (`rootid`, `ordernum`, `app`, `name`, `title`, `href`, `icon`, `class`, `a_class`, `target`, `caret`, `data-toggle`, `data-meta`, `data-target`) values('6','12','marker','标记管理','','marker','fa fa-bookmark','','','','','','','');
